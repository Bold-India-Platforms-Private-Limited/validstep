...
export function OpenLinkIcon({ className = 'h-3 w-3' }) {
  return (
    <svg viewBox="0 0 18 19" xmlns="http://www.w3.org/2000/svg" className={className}>
      <g>
        <line x1="9.7" y1="9.3" x2="1" y2="18" stroke="currentColor" strokeWidth="2.4" strokeLinecap="round" strokeLinejoin="round" />
        <polyline points="9.7,18 9.7,9.3 1,9.3" fill="none" stroke="currentColor" strokeWidth="2.4" strokeLinecap="round" strokeLinejoin="round" />
      </g>
    </svg>
  )
}
